...
<a href="/dashboardAdmin/kelolaGudangKebaikan"><i class="fa fa-fw fa-arrow-left"></i> Kembali</a>
  <span class="h3 mb-4 text-gray-800"><p style="text-align: center;">Perbarui Gudang</p></span>
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="card ">
        <div class="card-body">
          <h5 class="card-title text-center">Form Perbarui Gudang</h5>
          <?php if(session()->getFlashdata('pesan')): ?>
            <?= session()->getFlashdata('pesan'); ?>
          <?php endif; ?>
          <form method="post" action="/dashboardAdmin/perbaruiGudang/<?= $gudang['id'] ?>">
          <?= csrf_field(); ?>
            ...
            <div class="form-group">
              ...
              <input
                ...
                id="nama"
                name="nama"
                value="<?= (old('nama')) ? old('nama') : $gudang['nama_pj'] ?>"
              />
            ...
            <div class="form-group">
              ...
              <input
                ...
                id="telp"
                name="telp"
                value="<?= (old('telp')) ? old('telp') : $gudang['telp_pj'] ?>"
              />
              <div class="invalid-feedback">
            ...
            <div class="form-group">
              ...
              <input
                ...
                id="provinsi"
                name="provinsi"
                value="<?= (old('provinsi')) ? old('provinsi') : $gudang['provinsi'] ?>"
              />
              <div class="invalid-feedback">
            ...
            <div class="form-group">
              ...
              <input
                ...
                id="kotkab"
                name="kotkab"
                value="<?= (old('kotkab')) ? old('kotkab') : $gudang['kotkab'] ?>"
              />
              <div class="invalid-feedback">
            ...
            <div class="form-group">
              ...
              <input
                ...
                id="kecamatan"
                name="kecamatan"
                value="<?= (old('kecamatan')) ? old('kecamatan') : $gudang['kecamatan'] ?>"
              />
              <div class="invalid-feedback">
            ...
            <div class="form-group">
              ...
              <input
                ...
                id="deskel"
                name="deskel"
                value="<?= (old('deskel')) ? old('deskel') : $gudang['deskel'] ?>"
              />
              <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                <textarea
                  ...
                  name="alamat"
                  rows="3"
                ><?= (old('alamat')) ? old('alamat') : $gudang['alamat'] ?></textarea>
                <div class="invalid-feedback">
            ...
            <div class="form-group">
              <div class="col">
                <button type="submit" class="btn btn-primary" name="submit">Perbarui Gudang</button>
              </div>
            </div>
          </form>
        </div>
