...
<div class="container-fluid">
  ...
  <span class="h3 mb-4 text-gray-800"><p style="text-align: center;">Perbarui Pengajuan</p></span>
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="card">
        <div class="card-body">
          <h5 class="card-title text-center">Form Perbarui Pengajuan</h5>
          <?php if(session()->getFlashdata('pesan')): ?>
            <?= session()->getFlashdata('pesan'); ?>
          <?php endif; ?>
          <form
            method="post"
            action="/dashboard/perbaruiPengajuan/<?= $pengajuan['id'] ?>"
...
<?= (old('alamat')) ? old('alamat') : $pengajuan['alamat'] ?></textarea
            ...
            <div class="form-group">
              ...
              <select class="custom-select <?= ($validation->hasError('bank') ? 'is-invalid' : '') ?>" id="bank" name="bank">
                ...
                <option value="<?= $i['name'] ?>" <?= ($i['name'] == $pengajuan['bank']) ? 'selected' : ''?>><?= $i['name'] ?></option>
                <?php endforeach; ?>
              </select>
              <div class="invalid-feedback">
